...
for i in range(15):
    ...
    ballast_mass = 10e3
    atm_height = 1e5      #when "reentry" begins
    initial_velocity = 2060      #approx. Mach 6 on reentry
    ...
    while(running):
        ...
        rate(10000)   #simulation runs in real time
    ...
    angle = rocket.theta
    fuel_pctlist.append(rocket.fuel_pct)
    endvellist.append(speed)
    endtimelist.append(count)
    endanglist.append(angle*180/(pi))
    scene.delete()
